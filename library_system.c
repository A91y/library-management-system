...
void endScreen(){
    ...
    printf("----------------------------------------------\n");
    printf(">>> Creator: Ayush Agrawal <<< \n");
    printf("----------------------------------------------\n\n");

    printf("> Github: https://github.com/A91y \n");
    printf("> Twitter: https://twitter.com/AyushAgr91 \n");
    printf("> LinkedIn: https://www.linkedin.com/in/AyushAgr91 \n\n");
...
label4:
    ...
    (bookSearcher != 3) ? printf("Serach the book by Book name: ") : printf("Serach the book by Book name: ");
